...
export const AddEditMembershipPlanDialog: FC<AddEditMembershipPlanDialogProps> = ({
  ...
  const isSubmitting =
    createMembershipPlanMutation.isPending || updateMembershipPlanMutation.isPending;
      ...
      footer={{
        content: (
          <div className="flex justify-end gap-2">
            ...
            <Button type="submit" isLoading={isSubmitting} onClick={form.handleSubmit(onSubmit)}>
