...
const InvoiceTitle = ({ logoUrl }: { logoUrl: string }) => (
  <View style={styles.titleContainer}>
    <View style={styles.spaceBetween}>
      {/* eslint-disable jsx-a11y/alt-text */}
      <Image style={styles.logo} src={logoUrl} />
      <Text style={styles.reportTitle}>Xpress Enterprise</Text>
    </View>
  </View>
);
...
const Invoice = ({ logoUrl }: { logoUrl: string }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <InvoiceTitle logoUrl={logoUrl} />
        <Address />
        <UserAddress />
        <TableHead />
        <TableBody />
